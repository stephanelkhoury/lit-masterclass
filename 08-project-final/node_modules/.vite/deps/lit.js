...
if (NODE_MODE4) {
  (_a2 = global4.customElements) !== null && _a2 !== void 0 ? _a2 : global4.customElements = customElements;
}
var DEV_MODE2 = true;
...
var ReactiveElement2 = class extends HTMLElement {
  ...
  __propertyToAttribute(name, value, options = defaultPropertyDeclaration2) {
    ...
    const attr = this.constructor.__attributeNameForProperty(name, options);
    if (attr !== void 0 && options.reflect === true) {
      const converter = ((_a5 = options.converter) === null || _a5 === void 0 ? void 0 : _a5.toAttribute) !== void 0 ? options.converter : defaultConverter2;
      const attrValue = converter.toAttribute(value, options.type);
  ...
  _$attributeToProperty(name, value) {
    ...
    if (propName !== void 0 && this.__reflectingProperty !== propName) {
      const options = ctor.getPropertyOptions(propName);
      const converter = typeof options.converter === "function" ? { fromAttribute: options.converter } : ((_a5 = options.converter) === null || _a5 === void 0 ? void 0 : _a5.fromAttribute) !== void 0 ? options.converter : defaultConverter2;
      this.__reflectingProperty = propName;
      this[propName] = converter.fromAttribute(
        value,
        options.type
  ...
  requestUpdate(name, oldValue, options) {
    ...
    return DEV_MODE2 ? requestUpdateThenable2(this.localName) : void 0;
  }
  /**
   * Sets up the element to asynchronously update.
   */
...
polyfillSupport2 === null || polyfillSupport2 === void 0 ? void 0 : polyfillSupport2({ ReactiveElement: ReactiveElement2 });
if (DEV_MODE2) {
...
var issueWarning3;
if (DEV_MODE3) {
  (_a3 = global5.litIssuedWarnings) !== null && _a3 !== void 0 ? _a3 : global5.litIssuedWarnings = /* @__PURE__ */ new Set();
  issueWarning3 = (code, warning) => {
    warning += code ? ` See https://lit.dev/msg/${code} for more information.` : "";
    if (!global5.litIssuedWarnings.has(warning)) {
      console.warn(warning);
...
var wrap = ENABLE_SHADYDOM_NOPATCH && ((_b3 = global5.ShadyDOM) === null || _b3 === void 0 ? void 0 : _b3.inUse) && ((_c3 = global5.ShadyDOM) === null || _c3 === void 0 ? void 0 : _c3.noPatch) === true ? global5.ShadyDOM.wrap : (node) => node;
var trustedTypes3 = global5.trustedTypes;
var policy = trustedTypes3 ? trustedTypes3.createPolicy("lit-html", {
  createHTML: (s) => s
}) : void 0;
...
var d = NODE_MODE5 && global5.document === void 0 ? {
  createTreeWalker() {
    return {};
  }
} : document;
...
function resolveDirective(part, value, parent = part, attributeIndex) {
  ...
  if ((currentDirective === null || currentDirective === void 0 ? void 0 : currentDirective.constructor) !== nextDirectiveConstructor) {
    ...
    if (attributeIndex !== void 0) {
      ((_c5 = (_d4 = parent).__directives) !== null && _c5 !== void 0 ? _c5 : _d4.__directives = [])[attributeIndex] = currentDirective;
    } else {
...
var ChildPart = class _ChildPart {
  ...
  _$setValue(value, directiveParent = this) {
    ...
    if (isPrimitive(value)) {
      ...
      if (DEV_MODE3 && ((_a5 = this.options) === null || _a5 === void 0 ? void 0 : _a5.host) === value) {
...
var BooleanAttributePart = class extends AttributePart {
  ...
  _commitValue(value) {
    ...
    if (value && value !== nothing) {
      wrap(this.element).setAttribute(this.name, emptyStringForBooleanAttribute3);
    } else {
      wrap(this.element).removeAttribute(this.name);
    }
  }
...
var EventPart = class extends AttributePart {
  ...
  handleEvent(event) {
    ...
    if (typeof this._$committedValue === "function") {
      this._$committedValue.call((_b5 = (_a5 = this.options) === null || _a5 === void 0 ? void 0 : _a5.host) !== null && _b5 !== void 0 ? _b5 : this.element, event);
    } else {
...
var polyfillSupport3 = DEV_MODE3 ? global5.litHtmlPolyfillSupportDevMode : global5.litHtmlPolyfillSupport;
polyfillSupport3 === null || polyfillSupport3 === void 0 ? void 0 : polyfillSupport3(Template, ChildPart);
((_d3 = global5.litHtmlVersions) !== null && _d3 !== void 0 ? _d3 : global5.litHtmlVersions = []).push("2.8.0");
if (DEV_MODE3 && global5.litHtmlVersions.length > 1) {
...
var render = (value, container, options) => {
  ...
  const renderId = DEV_MODE3 ? debugLogRenderId++ : 0;
...
var LitElement = class extends ReactiveElement2 {
  ...
  createRenderRoot() {
    ...
    (_a5 = (_b5 = this.renderOptions).renderBefore) !== null && _a5 !== void 0 ? _a5 : _b5.renderBefore = renderRoot.firstChild;
    return renderRoot;
  }
  /**
   * Updates the element. This method reflects property values to attributes
